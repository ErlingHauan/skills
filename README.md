...
| Skill | Description |
| --- | --- |
| `altinn-app` | Guide for editing Altinn apps — layouts, data models, policies, texts, prefill, expressions, and process config |
| `issue-elaborator` | Transforms issue drafts into well-structured GitHub issue markdown with codebase context |
| `pep8-python-style` | Enforces PEP 8 conventions when writing, editing, or reviewing Python code |
